CREATE TABLE IF NOT EXISTS `arena_somatology_matches` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `started_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ended_at` DATETIME NULL,
  `map_name` VARCHAR(32) NOT NULL DEFAULT '2025arena5',
...
CREATE TABLE IF NOT EXISTS `arena_somatology_match_players` (
...
CREATE TABLE IF NOT EXISTS `arena_somatology_guild_stats` (
  `guild_id` INT UNSIGNED NOT NULL,
  `guild_name` VARCHAR(24) NOT NULL DEFAULT '',
  `arena_name` VARCHAR(50) NOT NULL DEFAULT 'Somatology Laboratory 7x7',
...
CREATE TABLE IF NOT EXISTS `arena_somatology_match_skill_usage` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `match_id` INT UNSIGNED NOT NULL,
  `char_id` INT UNSIGNED NOT NULL,
  `team` TINYINT UNSIGNED NOT NULL,
