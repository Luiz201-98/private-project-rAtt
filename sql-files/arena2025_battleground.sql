CREATE TABLE IF NOT EXISTS `arena2025_matches` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `started_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ended_at` DATETIME NULL,
  `map_name` VARCHAR(32) NOT NULL DEFAULT '2025arena1',
...
CREATE TABLE IF NOT EXISTS `arena2025_match_players` (
...
CREATE TABLE IF NOT EXISTS `arena2025_guild_stats` (
  `guild_id` INT UNSIGNED NOT NULL,
  `guild_name` VARCHAR(24) NOT NULL DEFAULT '',
  `arena_name` VARCHAR(50) NOT NULL DEFAULT 'Arena 2025 7x7',
...
CREATE TABLE IF NOT EXISTS `arena2025_match_skill_usage` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `match_id` INT UNSIGNED NOT NULL,
  `char_id` INT UNSIGNED NOT NULL,
  `team` TINYINT UNSIGNED NOT NULL,
