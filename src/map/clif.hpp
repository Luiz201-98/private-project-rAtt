...
/// ZC_DISPEL to nearby PCs that are enemies of bl only (party/guild/allies keep skill overhead).
...
bool clif_skill_nodamage_self( block_list* src, block_list& dst, uint16 skill_id, int32 heal, bool success = true );
